...
// construction. Uses the shared createKeyedLock (util/keyedLock.ts) but keeps its own
// independent lock namespace, since it guards a different file (installation.json, not
// members.json/membership.json) with different, unrelated callers.
